...
const Projects = () => {
    return (
        <div className="container mx-auto px-5 py-8 md:py-10 md:px-6 lg:py-10 lg:px-15 mb-8 justify-center items-center max-w-full text-gray-800 dark:text-gray-200">
